...
from M14_UI_Prototype_Bridge_DC_Widgets_Demo import (
    RetroTheme, DCNode, NodeStatus, DEMO_NODES, DEMO_EDGES,
    DEMO_CREW, DEMO_DEPTS, SRSState, init_srs, solve_flows
)
        ...
        for from_id, to_id in DEMO_EDGES:
            ...
            if from_node and to_node:
                line = QGraphicsLineItem(
                    from_node.x * 60 + 25, from_node.y * 40 + 15,
                    to_node.x * 60 + 25, to_node.y * 40 + 15
                )
...
class SRSInspectorWindow(DraggableWindow):
    ...
    def setup_srs_inspector(self):
        ...
        self.port_table.setHorizontalHeaderLabels(["Port", "Module", "Dir", "Resource", "Cap", "Online"])
